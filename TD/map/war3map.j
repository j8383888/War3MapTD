...
function Trig_RegSaleGoodsEventFunc002Conditions takes nothing returns nothing
    ...
    if ((GetItemTypeId(GetSoldItem()) == 'I00K')) then
        ...
        loop
            ...
            call SaveInteger(YDHT, YDTRIGGER_ANY2I_frame( udg_CardFrame[ydul_i]), 0xDDFE2744, udg_CardGroup[udg_SmRandomInt[ydul_i]])
            call SaveInteger(YDHT, DzF2I(udg_CardFrame[ydul_i]), 0xDDFE2744, udg_CardGroup[udg_SmRandomInt[ydul_i]])
            set ydul_i = ydul_i + 1
        endloop
...
function Trig_SelectEventFunc001Func001Conditions takes nothing returns nothing
    ...
    if ((HaveSavedBoolean(YDHT, GetUnitTypeId(GetTriggerUnit()), 0x3D45B913) == true)) then
        if ((GetTriggerPlayer() == GetLocalPlayer())) then
            ...
            loop
                exitwhen ydul_i > 3
                call DzFrameShow( udg_CardFrame[ydul_i], true )
                set ydul_i = ydul_i + 1
            endloop
        else
        endif
        ...
        if ((GetTriggerPlayer() == GetLocalPlayer())) then
            ...
            loop
                exitwhen ydul_i > 3
                call DzFrameShow( udg_CardFrame[ydul_i], false )
                set ydul_i = ydul_i + 1
            endloop
        else
        endif
...
function Trig_UIInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call DzFrameShow( udg_CardEff[0], false )
    call DzFrameShow( udg_CardEff[1], false )
    call DzFrameShow( udg_CardEff[2], false )
    call DzFrameShow( udg_CardEff[3], false )
    set ydl_timer = CreateTimer()
    call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 1)
...
// Trigger: GlobeInit
//===========================================================================
function Trig_GlobeInitFunc013Func002Func006T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    loop
        ...
        if ((GetPlayerController(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6)) == MAP_CONTROL_USER) and (GetPlayerSlotState(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6)) == PLAYER_SLOT_STATE_PLAYING)) then
            ...
            call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0xB6A6EBAA, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xB6A6EBAA))
            call TimerStart(ydl_timer, 1.00, false, function Trig_GlobeInitFunc013Func002Func006T)
        else
        endif
        set ydul_i = ydul_i + 1
    endloop
