...
globals
    ...
    trigger gg_trg_AShowTipsAction_______u = null
    ...
    trigger gg_trg_AShowTipsAction = null
endglobals
...
//显示Tips
//隐藏Tips
function Trig_AHideTipsActionActions takes nothing returns nothing
...
function Trig_AddXuanYunActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    if ((IsUnitInGroup(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xB6A6EBAA), udg_XuanYunGroup) == false)) then
        call YDWEUnitAddStun( LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xB6A6EBAA) )
...
function Trig_RegHurtEventFunc002Conditions takes nothing returns nothing
    ...
    if ((GetEventDamageSource() != null) and (GetEventDamage() > 1.00) and (GetPlayerController(GetOwningPlayer(GetEventDamageSource())) == MAP_CONTROL_USER)) then
        ...
        if ((HaveSavedReal(YDHT, GetHandleId( GetTriggerUnit()), 0x9EFCFBB9) == true)) then
            call YDWESetEventDamage( ( GetEventDamage() * LoadReal(YDHT, GetHandleId( GetTriggerUnit()), 0x9EFCFBB9) ) )
        else
        endif
...
function Trig_SelectCardActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6)), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA707D18B)))
    ...
    loop
        exitwhen ydul_i > 3
        call YDWESaveUnitIDByInteger( YDWEH2I(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6)), ydul_i, 0 )
        set ydul_i = ydul_i + 1
    endloop
...
function Trig_RefushCardFunc005T takes nothing returns nothing
    ...
    if ((LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 2)) then
        ...
        loop
            ...
            call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(LoadPlayerHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xA59BB4C6)), ydul_i))
...
function Trig_RefushCardActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    loop
        exitwhen ydul_i > 3
        call YDWESaveUnitIDByInteger( YDWEH2I(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6)), ydul_i, udg_CardGroup[udg_SmRandomInt[ydul_i]] )
        if ((LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA59BB4C6) == GetLocalPlayer())) then
            ...
            call SaveInteger(YDHT, DzF2I(udg_CardBtn[ydul_i]), 0xDDFE2744, udg_CardGroup[udg_SmRandomInt[ydul_i]])
...
function Trig_RegRoleSkillEventFunc002Conditions takes nothing returns nothing
    if ((GetSpellAbilityId() == 'A00M')) then
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(GetOwningPlayer(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xB6A6EBAA))), 0))
        ...
        if ((GetSpellAbilityId() == 'A00O')) then
            call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(GetOwningPlayer(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xB6A6EBAA))), 1))
            call UnitAddItem( GetTriggerUnit(), LoadItemHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744), 0x496052F0) )
        else
            if ((GetSpellAbilityId() == 'A00L')) then
                call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(GetOwningPlayer(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xB6A6EBAA))), 2))
                call UnitAddItem( GetTriggerUnit(), LoadItemHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744), 0x496052F0) )
            else
                if ((GetSpellAbilityId() == 'A00N')) then
                    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744, YDWEGetUnitIDByInteger(YDWEH2I(GetOwningPlayer(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xB6A6EBAA))), 3))
                    call UnitAddItem( GetTriggerUnit(), LoadItemHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xDDFE2744), 0x496052F0) )
                else
                endif
            endif
...
function Trig_ChaoZaiShanDianLianActions takes nothing returns nothing
    call YDWESetEventDamage( ( GetUnitState(GetTriggerUnit(), UNIT_STATE_MAX_LIFE) * 0.20 ) )
endfunction
//===========================================================================
...
function Trig_UIInitFunc026Func004003 takes nothing returns nothing
    call DzSyncData( "SelectCard", LoadStr(YDHT, DzF2I(DzGetTriggerUIEventFrame()), 0xB9B8D73D) )
endfunction
function Trig_UIInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    loop
        ...
        call DzFrameSetScript( udg_CardBtn[ydul_i], 3, "Trig_AHideTipsActionActions", false )
        call SaveStr(YDHT, DzF2I(udg_CardBtn[ydul_i]), 0xB9B8D73D, I2S(ydul_i))
...
function Trig_HardWareActions takes nothing returns nothing
    ...
    loop
        exitwhen ydul_i > 5
        call SaveInteger(YDHT, DzF2I(DzFrameGetItemBarButton(ydul_i)), 0xEAFE0942, ydul_i)
        call DzFrameSetScript( DzFrameGetItemBarButton(ydul_i), 2, "Trig_GoodsShowTipsActions", false )
        call DzFrameSetScript( DzFrameGetItemBarButton(ydul_i), 3, "Trig_AHideTipsActionActions", false )
        set ydul_i = ydul_i + 1
    endloop
endfunction
//===========================================================================
...
function Trig_GoodsShowTipsActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step) 
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xEAFE0942, LoadInteger(YDHT, DzF2I(DzGetTriggerUIEventFrame()), 0xEAFE0942))
    if ((IsUnitType(LoadUnitHandle(YDHT, GetHandleId( GetLocalPlayer()), 0xA2EA0670), UNIT_TYPE_HERO) == true)) then
        ...
        if ((UnitItemInSlot(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xA2EA0670), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xEAFE0942)) != null)) then
            ...
            if ((HaveSavedInteger(YDHT, GetItemTypeId(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0x496052F0)), 0xDDFE2744) == true)) then
                ...
                call Trig_AShowTipsActionActions()
            else
            endif
        else
        endif
...
function Trig_FrameShowTipsActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step) 
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xDDFE2744, LoadInteger(YDHT, DzF2I(DzGetTriggerUIEventFrame()), 0xDDFE2744))
    set udg_unitTypeTemp = LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step, 0xDDFE2744)
    call Trig_AShowTipsActionActions()
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger())*ydl_localvar_step)
endfunction
...
//===========================================================================
// Trigger: AShowTipsAction 复制
//===========================================================================
function Trig_AShowTipsAction_______uActions takes nothing returns nothing
...
//===========================================================================
function InitTrig_AShowTipsAction_______u takes nothing returns nothing
    set gg_trg_AShowTipsAction_______u = CreateTrigger()
    call DisableTrigger(gg_trg_AShowTipsAction_______u)
    call TriggerAddAction(gg_trg_AShowTipsAction_______u, function Trig_AShowTipsAction_______uActions)
endfunction
//===========================================================================
// Trigger: GameLogic
//===========================================================================
...
//===========================================================================
// Trigger: AShowTipsAction
//===========================================================================
function Trig_AShowTipsActionActions takes nothing returns nothing
    call DzFrameSetText( udg_TipsHeroName, (EXExecuteScript("(require'jass.slk').unit[" + I2S( udg_unitTypeTemp) + "]." + "Name")) )
    call DzFrameSetText( udg_TipsFoodTxt, (EXExecuteScript("(require'jass.slk').unit[" + I2S( udg_unitTypeTemp) + "]." + "fused")) )
    call DzFrameSetText( udg_TipsGoldTxt, (EXExecuteScript("(require'jass.slk').unit[" + I2S( udg_unitTypeTemp) + "]." + "goldcost")) )
    call DzFrameSetTexture( udg_TipsHead, (EXExecuteScript("(require'jass.slk').unit[" + I2S( udg_unitTypeTemp) + "]." + "Art")), 0 )
...
//===========================================================================
function InitTrig_AShowTipsAction takes nothing returns nothing
    set gg_trg_AShowTipsAction = CreateTrigger()
    call DisableTrigger(gg_trg_AShowTipsAction)
    call TriggerAddAction(gg_trg_AShowTipsAction, function Trig_AShowTipsActionActions)
endfunction
//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_AShowTipsAction_______u( )
