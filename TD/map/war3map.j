...
unitpool udg_MosterPool= null
group udg_MonsterGroup= null
integer udg_ExpPanel= 0
integer udg_TipsFoodPic= 0
integer udg_unitTypeTemp= 0
integer udg_GoodsType= 0
    // Generated
...
trigger gg_trg_ShowTipsAction= null
...
trigger gg_trg_GoodsShowTips= null
trigger gg_trg_FrameShowTips= null
trigger gg_trg_GameLogic= null
trigger gg_trg_MonsterPool= null
trigger gg_trg_MonsterEvent= null
trigger gg_trg_MonsterGo= null
...
function InitGlobals takes nothing returns nothing
    ...
    set udg_DamageSum=0
    set udg_MonsterGroup=CreateGroup()
endfunction
//***************************************************************************
//*
//*  Items
...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem('I00N', - 27145.0, 13822.9)
endfunction
//***************************************************************************
//*
//*  Unit Creation
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set gg_unit_h001_0002=CreateUnit(p, 'h001', - 26519.3, 13546.3, 274.029)
endfunction
//===========================================================================
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_rect1_1=Rect(- 27712.0, 12288.0, - 27584.0, 12416.0)
    set gg_rct_rect1_2=Rect(- 26880.0, 12352.0, - 26752.0, 12480.0)
    set gg_rct_rect1_3=Rect(- 26944.0, 13056.0, - 26816.0, 13184.0)
    set gg_rct_rect1_4=Rect(- 25536.0, 12992.0, - 25408.0, 13120.0)
    set gg_rct_rect1_5=Rect(- 24768.0, 13888.0, - 24640.0, 14016.0)
    set gg_rct_rect1_6=Rect(- 22048.0, 13888.0, - 21920.0, 14016.0)
    set gg_rct_rect1_7=Rect(- 21376.0, 12992.0, - 21248.0, 13120.0)
    set gg_rct_rect1_8=Rect(- 19968.0, 12992.0, - 19840.0, 13120.0)
    set gg_rct_rect1_9=Rect(- 20032.0, 5504.0, - 19904.0, 5632.0)
    set gg_rct_start=Rect(- 27776.0, 14272.0, - 27488.0, 14560.0)
    set gg_rct_rect1_5_5=Rect(- 23488.0, 13888.0, - 23360.0, 14016.0)
    set gg_rct_startP1=Rect(- 27232.0, 13536.0, - 26784.0, 13856.0)
    set gg_rct_startP2=Rect(- 20352.0, 13440.0, - 19904.0, 13760.0)
    set gg_rct_startP3=Rect(- 20032.0, 4896.0, - 19584.0, 5216.0)
    set gg_rct_startP4=Rect(- 27264.0, 4800.0, - 26816.0, 5120.0)
    set gg_rct_rect1_10=Rect(- 21440.0, 5568.0, - 21312.0, 5696.0)
    set gg_rct_rect1_11=Rect(- 22080.0, 6464.0, - 21952.0, 6592.0)
    set gg_rct_rect1_12=Rect(- 23488.0, 6464.0, - 23360.0, 6592.0)
    set gg_rct_rect1_13=Rect(- 23488.0, 7232.0, - 23360.0, 7360.0)
    set gg_rct______________019=Rect(- 26720.0, 13856.0, - 26400.0, 14240.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
...
//===========================================================================
// Trigger: ShowTipsAction
//===========================================================================
function Trig_ShowTipsActionActions takes nothing returns nothing
    call DzFrameShow(DzFrameGetTooltip(), false)
    if ( ( udg_unitTypeTemp != 0 ) ) then
        call DzFrameSetText(udg_TipsHeroName, ( EXExecuteScript("(require'jass.slk').unit[" + I2S(udg_unitTypeTemp) + "].Name") ))
        call DzFrameSetText(udg_TipsGoldTxt, ( EXExecuteScript("(require'jass.slk').unit[" + I2S(udg_unitTypeTemp) + "].goldcost") ))
        call DzFrameSetTexture(udg_TipsHead, ( EXExecuteScript("(require'jass.slk').unit[" + I2S(udg_unitTypeTemp) + "].Art") ), 0)
        call DzFrameSetText(udg_TipsFoodTxt, ( EXExecuteScript("(require'jass.slk').unit[" + I2S(udg_unitTypeTemp) + "].fused") ))
        call DzFrameShow(udg_JiBanPanelFrame[0], true)
        call DzFrameShow(udg_JiBanPanelFrame[1], true)
        call DzFrameShow(udg_ExpPanel, true)
        call DzFrameShow(udg_TipsFoodTxt, true)
        call DzFrameShow(udg_TipsFoodPic, true)
    else
        call DzFrameSetText(udg_TipsHeroName, ( EXExecuteScript("(require'jass.slk').item[" + I2S(udg_GoodsType) + "].Name") ))
        call DzFrameSetTexture(udg_TipsHead, ( EXExecuteScript("(require'jass.slk').item[" + I2S(udg_GoodsType) + "].Art") ), 0)
        call DzFrameShow(udg_JiBanPanelFrame[0], false)
        call DzFrameShow(udg_JiBanPanelFrame[1], false)
        call DzFrameShow(udg_ExpPanel, false)
        call DzFrameShow(udg_TipsFoodTxt, false)
        call DzFrameShow(udg_TipsFoodPic, false)
        if ( true ) then
        else
        endif
    endif
...
//===========================================================================
function InitTrig_ShowTipsAction takes nothing returns nothing
    set gg_trg_ShowTipsAction=CreateTrigger()
    call DisableTrigger(gg_trg_ShowTipsAction)
    call TriggerAddAction(gg_trg_ShowTipsAction, function Trig_ShowTipsActionActions)
endfunction
//===========================================================================
// Trigger: MoveRect
//
    ...
    if ( ( LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA59BB4C6) == GetLocalPlayer() ) ) then
        ...
        loop
            ...
            if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA707D18B) == ydul_i ) ) then
                ...
                call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 4, udg_CardBtn[ydul_i], 4, - 0.0008, 0.00)
                ...
                call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 4, udg_CardBtn[ydul_i], 4, - 0.0008, 0.003)
...
// Trigger: UIInit
//===========================================================================
function Trig_UIInitFunc026Func004003 takes nothing returns nothing
...
function Trig_UIInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    // 刷卡UI
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31, DzCreateFrameByTagName("BACKDROP", "name", DzGetGameUI(), "UI_BACKDROP", 0))
    call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), 0, DzFrameGetPortrait(), 0, - 0.0005, 0.07)
    call DzFrameSetSize(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), 0.185, 0.06)
    call DzFrameSetTexture(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), "war3mapImported\\s2_rank_bg.tga", 0)
    ...
    loop
        ...
        call DzFrameSetPoint(udg_CardBtn[ydul_i], 0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), 0, ( ( 0.01 ) + ( ( 0.046 * I2R(ydul_i) ) ) ), - 0.01)
        call DzFrameSetSize(udg_CardBtn[ydul_i], 0.038, 0.042)
        call DzFrameSetScriptByCode(udg_CardBtn[ydul_i], 1, function Trig_UIInitFunc026Func004003, false)
        call DzFrameSetScript(udg_CardBtn[ydul_i], 2, "Trig_FrameShowTipsActions", false)
        call DzFrameSetScript(udg_CardBtn[ydul_i], 3, "Trig_HideTips", false)
        ...
        call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 4, udg_CardBtn[ydul_i], 4, - 0.0005, ( ( 0.0015 ) + ( 0.00 ) ))
        call DzFrameSetSize(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 0.055, 0.058)
        set udg_CardFrontEff[ydul_i]=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490)
        call DzFrameShow(udg_CardFrontEff[ydul_i], false)
        // 转圈特效UI
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490, DzCreateFrameByTagName("BACKDROP", "name", LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), "UI_BACKDROP", 0))
        call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 4, udg_CardBtn[ydul_i], 4, - 0.0005, ( ( 0.0008 ) + ( 0.00 ) ))
        call DzFrameSetSize(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 0.055, 0.058)
    ...
    call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), 8, DzGetGameUI(), 8, 0.00, 0.145)
    ...
    call DzFrameSetSize(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 0.018, 0.023)
    set udg_TipsFoodPic=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2DA1D060, DzCreateFrameByTagName("TEXT", "name", LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2A5D9A31), "text012", 0))
    call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x2DA1D060), 3, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 5, 0.005, 0.00)
    ...
    set udg_ExpPanel=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490)
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB0A4E872, DzCreateFrameByTagName("BACKDROP", "name", LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), "UI_BACKDROP", 0))
    ...
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x39AEB7E2, DzCreateFrameByTagName("BACKDROP", "name", LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), "UI_BACKDROP", 0))
    ...
    call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xED8CDF92), 6, DzGetGameUI(), 6, 0.00, 0.156)
...
function Trig_HardWareActions takes nothing returns nothing
    ...
    loop
        exitwhen ydul_i > 5
        call SaveInteger(YDHT, ((DzFrameGetItemBarButton(ydul_i))), 0xEAFE0942, ydul_i) // INLINED!!
        call DzFrameSetScript(DzFrameGetItemBarButton(ydul_i), 2, "Trig_GoodsShowTipsActions", false)
        call DzFrameSetScript(DzFrameGetItemBarButton(ydul_i), 3, "Trig_HideTips", false)
        set ydul_i=ydul_i + 1
    endloop
endfunction
//===========================================================================
...
//===========================================================================
// Trigger: GoodsShowTips
//===========================================================================
function Trig_GoodsShowTipsActions takes nothing returns nothing
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xEAFE0942, LoadInteger(YDHT, ((DzGetTriggerUIEventFrame())), 0xEAFE0942)) // INLINED!!
    if ( ( IsUnitType(LoadUnitHandle(YDHT, GetHandleId(GetLocalPlayer()), 0xA2EA0670), UNIT_TYPE_HERO) == true ) ) then
        call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA2EA0670, LoadUnitHandle(YDHT, GetHandleId(GetLocalPlayer()), 0xA2EA0670))
        if ( ( UnitItemInSlot(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA2EA0670), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xEAFE0942)) != null ) ) then
            call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, UnitItemInSlot(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA2EA0670), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xEAFE0942)))
            if ( ( HaveSavedInteger(YDHT, GetItemTypeId(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0)), 0xDDFE2744) == true ) ) then
                call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xDDFE2744, LoadInteger(YDHT, GetItemTypeId(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0)), 0xDDFE2744))
                set udg_unitTypeTemp=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xDDFE2744)
                call Trig_ShowTipsActionActions()
            else
                set udg_GoodsType=GetItemTypeId(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
                set udg_unitTypeTemp=0
                call Trig_ShowTipsActionActions()
            endif
        else
        endif
...
//===========================================================================
function InitTrig_GoodsShowTips takes nothing returns nothing
    set gg_trg_GoodsShowTips=CreateTrigger()
    call DisableTrigger(gg_trg_GoodsShowTips)
    call TriggerAddAction(gg_trg_GoodsShowTips, function Trig_GoodsShowTipsActions)
endfunction
//===========================================================================
// Trigger: FrameShowTips
//===========================================================================
function Trig_FrameShowTipsActions takes nothing returns nothing
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xDDFE2744, LoadInteger(YDHT, ((DzGetTriggerUIEventFrame())), 0xDDFE2744)) // INLINED!!
    set udg_unitTypeTemp=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xDDFE2744)
    call Trig_ShowTipsActionActions()
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
endfunction
//===========================================================================
function InitTrig_FrameShowTips takes nothing returns nothing
    set gg_trg_FrameShowTips=CreateTrigger()
    call DisableTrigger(gg_trg_FrameShowTips)
    call TriggerAddAction(gg_trg_FrameShowTips, function Trig_FrameShowTipsActions)
endfunction
//===========================================================================
// Trigger: GameLogic
//===========================================================================
function Trig_GameLogicFunc001Func001T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) ) - ( 1 ) ))
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == - 1 ) ) then
        set ydl_trigger=gg_trg_GameLogic
        set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
        call TriggerExecute(ydl_trigger)
        call DzFrameSetText(udg_TimeTxt, ( ( "|CffFFC926" ) + ( I2S(5) ) + ( "|r" ) ))
        call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
        call DestroyTimer(GetExpiredTimer())
    else
        call DzFrameSetText(udg_TimeTxt, ( ( "|CffFFC926" ) + ( I2S(LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820)) ) + ( "|r" ) ))
    endif
    set ydl_trigger=null
endfunction
function Trig_GameLogicFunc001Func002T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) ) - ( 1 ) ))
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == - 1 ) ) then
        ...
        set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
        call TriggerExecute(ydl_trigger)
        call DzFrameSetText(udg_TimeTxt, ( ( "|CffFFC926" ) + ( I2S(60) ) + ( "|r" ) ))
        call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
        call DestroyTimer(GetExpiredTimer())
    else
        call DzFrameSetText(udg_TimeTxt, ( ( "|CffFFC926" ) + ( I2S(LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820)) ) + ( "|r" ) ))
...
function Trig_GameLogicFunc004A takes nothing returns nothing
    call KillUnit(GetEnumUnit())
endfunction
function Trig_GameLogicActions takes nothing returns nothing
    local timer ydl_timer
    local group ydl_group
    local unit ydl_unit
    local integer ydl_triggerstep
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    if ( ( udg_debug == true ) ) then
        set ydl_timer=CreateTimer()
        call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 5)
        call TimerStart(ydl_timer, 1.00, true, function Trig_GameLogicFunc001Func001T)
    else
        set ydl_timer=CreateTimer()
        call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 60)
        call TimerStart(ydl_timer, 1.00, true, function Trig_GameLogicFunc001Func002T)
    endif
    set udg_WaveNum=( udg_WaveNum + 1 )
    call DzFrameSetText(udg_WaveTxt, ( ( "|Cff4DFF4D第" ) + ( I2S(udg_WaveNum) ) + ( "波|r" ) ))
    call ForGroupBJ(udg_MonsterGroup, function Trig_GameLogicFunc004A)
    call GroupClear(udg_MonsterGroup)
    // 怪物池变更
    set ydl_trigger=gg_trg_MonsterPool
    set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
    call TriggerExecute(ydl_trigger)
    // 怪物出现
    set ydl_trigger=gg_trg_MonsterGo
    set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
    call TriggerExecute(ydl_trigger)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_timer=null
...
//===========================================================================
function InitTrig_GameLogic takes nothing returns nothing
    set gg_trg_GameLogic=CreateTrigger()
    call DisableTrigger(gg_trg_GameLogic)
    call TriggerAddAction(gg_trg_GameLogic, function Trig_GameLogicActions)
endfunction
//===========================================================================
// Trigger: MonsterPool
//===========================================================================
function Trig_MonsterPoolActions takes nothing returns nothing
    call DestroyUnitPool(udg_MosterPool)
    set udg_MosterPool=CreateUnitPool()
    if ( ( udg_WaveNum == 1 ) ) then
        call UnitPoolAddUnitType(udg_MosterPool, 'u005', 1)
    else
        if ( ( udg_WaveNum == 2 ) ) then
            call UnitPoolAddUnitType(udg_MosterPool, 'u001', 1)
        else
            if ( ( udg_WaveNum == 3 ) ) then
                call UnitPoolAddUnitType(udg_MosterPool, 'u006', 1)
            else
                if ( ( udg_WaveNum == 4 ) ) then
                    call UnitPoolAddUnitType(udg_MosterPool, 'u007', 1)
                else
                    if ( ( udg_WaveNum == 5 ) ) then
                        call UnitPoolAddUnitType(udg_MosterPool, 'u008', 1)
                    else
                        if ( ( udg_WaveNum == 6 ) ) then
                            call UnitPoolAddUnitType(udg_MosterPool, 'u00A', 1)
                        else
                            if ( ( udg_WaveNum == 7 ) ) then
                                call UnitPoolAddUnitType(udg_MosterPool, 'u00B', 1)
                            else
                                if ( ( udg_WaveNum == 8 ) ) then
                                    call UnitPoolAddUnitType(udg_MosterPool, 'u00C', 1)
                                else
                                    if ( ( udg_WaveNum == 9 ) ) then
                                        call UnitPoolAddUnitType(udg_MosterPool, 'u00D', 1)
                                    else
                                        if ( ( udg_WaveNum == 10 ) ) then
                                            call UnitPoolAddUnitType(udg_MosterPool, 'u00E', 1)
                                        else
                                            if ( ( udg_WaveNum == 11 ) ) then
                                                call UnitPoolAddUnitType(udg_MosterPool, 'u00G', 1)
                                            else
                                                if ( ( udg_WaveNum == 12 ) ) then
                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u00H', 1)
                                                else
                                                    if ( ( udg_WaveNum == 13 ) ) then
                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u00I', 1)
                                                    else
                                                        if ( ( udg_WaveNum == 14 ) ) then
                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u00J', 1)
                                                        else
                                                            if ( ( udg_WaveNum == 15 ) ) then
                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u00K', 1)
                                                            else
                                                                if ( ( udg_WaveNum == 16 ) ) then
                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u00M', 1)
                                                                else
                                                                    if ( ( udg_WaveNum == 17 ) ) then
                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u00N', 1)
                                                                    else
                                                                        if ( ( udg_WaveNum == 18 ) ) then
                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u00O', 1)
                                                                        else
                                                                            if ( ( udg_WaveNum == 19 ) ) then
                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u00P', 1)
                                                                            else
                                                                                if ( ( udg_WaveNum == 20 ) ) then
                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u00Q', 1)
                                                                                else
                                                                                    if ( ( udg_WaveNum == 21 ) ) then
                                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u00S', 1)
                                                                                    else
                                                                                        if ( ( udg_WaveNum == 22 ) ) then
                                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u00T', 1)
                                                                                        else
                                                                                            if ( ( udg_WaveNum == 23 ) ) then
                                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u00U', 1)
                                                                                            else
                                                                                                if ( ( udg_WaveNum == 24 ) ) then
                                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u00V', 1)
                                                                                                else
                                                                                                    if ( ( udg_WaveNum == 25 ) ) then
                                                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u00W', 1)
                                                                                                    else
                                                                                                        if ( ( udg_WaveNum == 26 ) ) then
                                                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u00Y', 1)
                                                                                                        else
                                                                                                            if ( ( udg_WaveNum == 27 ) ) then
                                                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u00Z', 1)
                                                                                                            else
                                                                                                                if ( ( udg_WaveNum == 28 ) ) then
                                                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u010', 1)
                                                                                                                else
                                                                                                                    if ( ( udg_WaveNum == 29 ) ) then
                                                                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u011', 1)
                                                                                                                    else
                                                                                                                        if ( ( udg_WaveNum == 30 ) ) then
                                                                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u013', 1)
                                                                                                                        else
                                                                                                                            if ( ( udg_WaveNum == 31 ) ) then
                                                                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u002', 1)
                                                                                                                            else
                                                                                                                                if ( ( udg_WaveNum == 32 ) ) then
                                                                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u003', 1)
                                                                                                                                else
                                                                                                                                    if ( ( udg_WaveNum == 33 ) ) then
                                                                                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u004', 1)
                                                                                                                                    else
                                                                                                                                        if ( ( udg_WaveNum == 34 ) ) then
                                                                                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u014', 1)
                                                                                                                                        else
                                                                                                                                            if ( ( udg_WaveNum == 35 ) ) then
                                                                                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u015', 1)
                                                                                                                                            else
                                                                                                                                                if ( ( udg_WaveNum == 36 ) ) then
                                                                                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u017', 1)
                                                                                                                                                else
                                                                                                                                                    if ( ( udg_WaveNum == 37 ) ) then
                                                                                                                                                        call UnitPoolAddUnitType(udg_MosterPool, 'u018', 1)
                                                                                                                                                    else
                                                                                                                                                        if ( ( udg_WaveNum == 38 ) ) then
                                                                                                                                                            call UnitPoolAddUnitType(udg_MosterPool, 'u019', 1)
                                                                                                                                                        else
                                                                                                                                                            if ( ( udg_WaveNum == 39 ) ) then
                                                                                                                                                                call UnitPoolAddUnitType(udg_MosterPool, 'u01A', 1)
                                                                                                                                                            else
                                                                                                                                                                if ( ( udg_WaveNum == 40 ) ) then
                                                                                                                                                                    call UnitPoolAddUnitType(udg_MosterPool, 'u01B', 1)
                                                                                                                                                                else
                                                                                                                                                                endif
                                                                                                                                                            endif
                                                                                                                                                        endif
...
//===========================================================================
function InitTrig_MonsterPool takes nothing returns nothing
    set gg_trg_MonsterPool=CreateTrigger()
    call DisableTrigger(gg_trg_MonsterPool)
    call TriggerAddAction(gg_trg_MonsterPool, function Trig_MonsterPoolActions)
endfunction
//===========================================================================
// Trigger: MonsterEvent
//
// unit
//===========================================================================
function Trig_MonsterEventActions takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call GroupAddUnit(udg_MonsterGroup, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB6A6EBAA))
...
//===========================================================================
function InitTrig_MonsterEvent takes nothing returns nothing
    set gg_trg_MonsterEvent=CreateTrigger()
    call DisableTrigger(gg_trg_MonsterEvent)
    call TriggerAddAction(gg_trg_MonsterEvent, function Trig_MonsterEventActions)
endfunction
//===========================================================================
// Trigger: MonsterGo
//===========================================================================
function Trig_MonsterGoFunc001T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    call SaveUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xB6A6EBAA, PlaceRandomUnit(udg_MosterPool, Player(6), GetRectCenterX(gg_rct_start), GetRectCenterY(gg_rct_start), 0))
    ...
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) + 1 ))
    set ydl_trigger=gg_trg_MonsterEvent
    set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
    call SaveUnitHandle(YDLOC, ydl_triggerstep, 0xB6A6EBAA, LoadUnitHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xB6A6EBAA))
    call TriggerExecute(ydl_trigger)
    if ( ( udg_debug == true ) ) then
        if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 5 ) ) then
            call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
            call DestroyTimer(GetExpiredTimer())
        else
        endif
    else
        if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 30 ) ) then
            call FlushChildHashtable(YDLOC, GetHandleId(GetExpiredTimer()))
            call DestroyTimer(GetExpiredTimer())
        else
        endif
...
function Trig_MonsterGoActions takes nothing returns nothing
    local timer ydl_timer
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call TimerStart(ydl_timer, 1.00, true, function Trig_MonsterGoFunc001T)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_timer=null
endfunction
//===========================================================================
function InitTrig_MonsterGo takes nothing returns nothing
    set gg_trg_MonsterGo=CreateTrigger()
    call DisableTrigger(gg_trg_MonsterGo)
    call TriggerAddAction(gg_trg_MonsterGo, function Trig_MonsterGoActions)
endfunction
//===========================================================================
// Trigger: CardInit
//===========================================================================
function Trig_CardInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00L'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I000')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00F'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I001')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00M'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I002')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00B'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I003')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00J'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I004')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00G'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I005')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00K'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I006')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00N'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I007')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H004'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I008')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00H'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I009')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H005'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00A')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H006'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00B')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H007'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00C')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H008'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00D')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00C'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00E')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00D'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00F')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H009'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00G')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00I'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00H')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00E'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00I')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820) ) + ( 1 ) ))
    set udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]='H00A'
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0, 'I00J')
    call SaveInteger(YDHT, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0x496052F0, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0))
    call SaveInteger(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x496052F0), 0xDDFE2744, udg_CardGroup[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)])
    set udg_CardGroupLen=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)
    call BJDebugMsg(( "牌组总数：" + I2S(udg_CardGroupLen) ))
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
endfunction
//===========================================================================
...
// Trigger: GlobeInit
//===========================================================================
function Trig_GlobeInitFunc031Func002Func010T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
...
function Trig_GlobeInitFunc046Func001T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) ) - ( 1 ) ))
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 0 ) ) then
        set ydl_trigger=gg_trg_GameLogic
        set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
        call TriggerExecute(ydl_trigger)
        call DzFrameSetText(udg_TimeTxt, ( ( "|CffFFC926" ) + ( I2S(5) ) + ( "|r" ) ))
...
function Trig_GlobeInitFunc046Func002T takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) ) - ( 1 ) ))
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 0 ) ) then
...
function Trig_GlobeInitFunc046Func003A takes nothing returns nothing
...
function Trig_GlobeInitFunc047A takes nothing returns nothing
    local integer ydl_triggerstep
    local trigger ydl_trigger
    set ydl_trigger=gg_trg_RefushCard
    set ydl_triggerstep=GetHandleId(ydl_trigger) * ( LoadInteger(YDLOC, GetHandleId(ydl_trigger), 0xCFDE6C76) + 3 )
...
function Trig_GlobeInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call SavePlayerHandle(YDHT, GetHandleId(Player(0)), 0x311CCD38, Player(6))
    call SavePlayerHandle(YDHT, GetHandleId(Player(1)), 0x311CCD38, Player(7))
    call SavePlayerHandle(YDHT, GetHandleId(Player(2)), 0x311CCD38, Player(8))
    call SavePlayerHandle(YDHT, GetHandleId(Player(3)), 0x311CCD38, Player(9))
    ...
    loop
        ...
        if ( ( GetPlayerController(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA59BB4C6)) == MAP_CONTROL_USER ) and ( GetPlayerSlotState(LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA59BB4C6)) == PLAYER_SLOT_STATE_PLAYING ) ) then
            ...
            call SaveUnitHandle(YDLOC, GetHandleId(ydl_timer), 0xB6A6EBAA, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB6A6EBAA))
            call TimerStart(ydl_timer, 1.00, false, function Trig_GlobeInitFunc031Func002Func010T)
        else
        endif
        set ydul_i=ydul_i + 1
    endloop
    ...
    if ( ( udg_debug == true ) ) then
        set ydl_timer=CreateTimer()
        call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 5)
        call TimerStart(ydl_timer, 1.00, true, function Trig_GlobeInitFunc046Func001T)
        call ForForce(udg_playerGroup, function Trig_GlobeInitFunc046Func003A)
    else
        set ydl_timer=CreateTimer()
        call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 60)
        call TimerStart(ydl_timer, 1.00, true, function Trig_GlobeInitFunc046Func002T)
    endif
    call ForForce(udg_playerGroup, function Trig_GlobeInitFunc047A)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_trigger=null
    set ydl_timer=null
endfunction
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_GoodsShowTips()
    call InitTrig_FrameShowTips()
    call InitTrig_GameLogic()
    call InitTrig_MonsterPool()
    call InitTrig_MonsterEvent()
    call InitTrig_MonsterGo()
...
function main takes nothing returns nothing
    call SetCameraBounds(- 29696.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 1664.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), - 16384.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 15744.0 - GetCameraMargin(CAMERA_MARGIN_TOP), - 29696.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 15744.0 - GetCameraMargin(CAMERA_MARGIN_TOP), - 16384.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 1664.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(0, - 17664.0, 3840.0)
    call DefineStartLocation(1, - 18048.0, 13504.0)
    call DefineStartLocation(2, - 17408.0, 5760.0)
    call DefineStartLocation(3, - 18496.0, 12864.0)
    call DefineStartLocation(4, - 21312.0, 14080.0)
    call DefineStartLocation(5, - 18752.0, 12032.0)
    call DefineStartLocation(6, - 17280.0, 6912.0)
    call DefineStartLocation(7, - 17344.0, 8896.0)
    call DefineStartLocation(8, - 18496.0, 13376.0)
    call DefineStartLocation(9, - 19328.0, 4864.0)
    call DefineStartLocation(10, - 18880.0, 13504.0)
    call DefineStartLocation(11, - 19392.0, 13120.0)
    // Player setup
