...
// Trigger: SelectCard
//===========================================================================
function Trig_SelectCardFunc004T takes nothing returns nothing
    local integer ydul_i
    call SaveInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820, ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) + 1 ))
    if ( ( LoadPlayerHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xA59BB4C6) == GetLocalPlayer() ) ) then
        if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 1 ) ) then
            call DzFrameShow(udg_CardSelectFrame[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xA707D18B)], true)
        else
        endif
        call DzFrameSetTexture(udg_CardSelectFrame[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xA707D18B)], ( ( "war3mapImported\\buy_eff_" ) + ( I2S(LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820)) ) + ( ".blp" ) ), 0)
    else
    endif
    ...
    if ( ( LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0x25DAB820) == 23 ) ) then
        if ( ( LoadPlayerHandle(YDLOC, GetHandleId(GetExpiredTimer()), 0xA59BB4C6) == GetLocalPlayer() ) ) then
            call DzFrameShow(udg_CardSelectFrame[LoadInteger(YDLOC, GetHandleId(GetExpiredTimer()), 0xA707D18B)], false)
        else
        endif
...
function Trig_SelectCardActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xF798B817, S2I(DzGetTriggerSyncData()))
    call SavePlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA59BB4C6, DzGetTriggerSyncPlayer())
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xDDFE2744, (LoadInteger(YDHT, ((GetHandleId((LoadPlayerHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xA59BB4C6)))) ), ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xF798B817))))) // INLINED!!
    ...
    call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0x25DAB820, 0)
    call SaveInteger(YDLOC, GetHandleId(ydl_timer), 0xA707D18B, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xF798B817))
    ...
    call TimerStart(ydl_timer, 0.03, true, function Trig_SelectCardFunc004T)
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
    set ydl_timer=null
endfunction
//===========================================================================
...
// Trigger: UIInit
//===========================================================================
function Trig_UIInitFunc014Func004003 takes nothing returns nothing
...
function Trig_UIInitActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    loop
        exitwhen ydul_i > 3
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490, DzCreateFrame(( "UI_Hero_Btn" + I2S(ydul_i) ), DzGetGameUI(), 0))
        ...
        set udg_CardBtn[ydul_i]=LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490)
        call DzFrameSetScriptByCode(udg_CardBtn[ydul_i], 1, function Trig_UIInitFunc014Func004003, true)
        ...
        // 转圈特效UI
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490, DzCreateFrameByTagName("BACKDROP", "name", DzGetGameUI(), "UI_BACKDROP", 0))
        call DzFrameSetPoint(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 4, DzFrameGetCommandBarButton(0, ydul_i), 4, - 0.0005, 0.0008)
        call DzFrameSetSize(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC7389490), 0.055, 0.058)
